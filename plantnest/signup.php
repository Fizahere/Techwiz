...
<main id="mainSignup">
                    ...
                    <div class="login-register">
                        ...
                        <form action="#" method='post'>
                            <div class="login-register__form">
                                ...
                                <div class="single-form">
                                    <input class="single-form__input" id="lastname" name="fullname" type="text"
                                        placeholder="Last name *"  />
                                    <span id="errorLastName"></span>
                                </div>
                                <div class="single-form">
                                    <input class="single-form__input" id="email" name="email" type=""
                                        placeholder="Email address *"  />
                                    <span id="errorEmail"></span>
                                </div>

                                <div class="single-form">
                                    <input class="single-form__input" id="password" type="password" name="password"
                                        placeholder="Password *"  />
                                    <span id="errorPassword"></span>
                                </div>
                                <div class="single-form">
                                    <input class="single-form__input" id="confirmpassword" type="password" name="confirmpassword"
    ...
    if (email == "") {
        ...
        $(this).next().html('Please enter a valid email address').css({ 'color': 'red' });
        $(this).css({ 'border': '1px solid red' });
        error= true;
    } else {
        $(this).next().html('');
  ...
  if(value==''){
    ...
    $(id).next().html('This field is ').css({ 'color':'red'});
