                                ...
                                <div class="swiper">
                                    <div class="swiper-wrapper">
                                        <div class="product-single-slide-item swiper-slide">
                                            <img src="assets/images/products/product-single-01.png" alt="Product Single" width="694" height="728" />
                                        </div>
                                        <div class="product-single-slide-item swiper-slide">
                                            <img src="assets/images/products/product-single-02.png" alt="Product Single" width="694" height="728" />
                                        </div>
                                        <div class="product-single-slide-item swiper-slide">
                                            <img src="assets/images/products/product-single-03.png" alt="Product Single" width="694" height="728" />
                                        </div>
                                        <div class="product-single-slide-item swiper-slide">
                                            <img src="assets/images/products/product-single-04.png" alt="Product Single" width="694" height="728" />
                                        </div>
                                    </div>
                                ...
                                <div class="swiper">
                                    <div class="swiper-wrapper">
                                        <div class="product-single-thumb-item swiper-slide">
                                            <img src="assets/images/products/product-single-01.png" alt="Product Single Thumbnail" width="144" height="155" />
                                        </div>
                                        <div class="product-single-thumb-item swiper-slide">
                                            <img src="assets/images/products/product-single-02.png" alt="Product Single Thumbnail" width="144" height="155" />
                                        </div>
                                        <div class="product-single-thumb-item swiper-slide">
                                            <img src="assets/images/products/product-single-03.png" alt="Product Single Thumbnail" width="144" height="155" />
                                        </div>
                                        <div class="product-single-thumb-item swiper-slide">
                                            <img src="assets/images/products/product-single-04.png" alt="Product Single Thumbnail" width="144" height="155" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="product-single-col-2">
                        ...
                        <div class="product-single-content">
                            ...
                            <div class="product-single-content__add-to-cart-wrapper">
                                <a class="product-single-content__add-to-cart btn" href="#">
                                    Buy Now
                                </a>
                            </div>
...
<!-- Mirrored from htmldemo.net/plantfy/plantfy/product-single-affiliate.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Aug 2023 21:01:00 GMT -->
</html>