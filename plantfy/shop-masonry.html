...
<!-- Mirrored from htmldemo.net/plantfy/plantfy/shop-masonry.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Aug 2023 21:00:56 GMT -->
<head>
    <meta charset="utf-8" />
    ...
    <main>
        ...
        <div class="breadcrumb-section">
            <div class="container-fluid custom-container">
                <div class="breadcrumb-wrapper text-center">
                    <h2 class="breadcrumb-wrapper__title">Shop Masonry</h2>
        ...
        <div class="shop-section section-padding-2">
            <div class="container-fluid custom-container">
                            ...
                            <div class="filter-widget-col">
                                ...
                                <div class="widget-item">
                                    ...
                                    <div class="widget-item__filter category-filter">
                                        <ul class="widget-item__list category">
                                            <li class="active">
                                ...
                                <div class="widget-item">
                                    ...
                                    <div class="widget-item__filter">
                                        <ul class="widget-item__list price">
                                            ...
                                            <li>
                                                <a href="#">$30.00 - $50.00</a>
                                            </li>
                                            <li>
                                                <a href="#">$50.00 - $70.00</a>
                                            </li>
                                            <li>
                                                <a href="#">$70.00 - $100.00</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="widget-item">
                                    ...
                                    <div class="widget-item__filter">
                                        <ul class="widget-item__color">
                                            ...
                                            <li>
                                                <a class="polar-blue" href="#">Polar Blue</a>
                                            </li>
                                            <li>
                ...
                <!-- Shop Wrapper Start -->
                <div class="shop-wrapper shop-masonry">
                    <div class="row">
